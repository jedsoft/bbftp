...
int sendafile(int code) {
    ...
    */
    ...
    if ( code == MSG_RETR ) {
        ...
        bbftpd_log(BBFTPD_DEBUG,"Retreiving file %s with %d children",readfilename,msg_store->nbport) ;
    } else {
        compressiontype = COMPRESSION ;
        bbftpd_log(BBFTPD_DEBUG,"Retreiving file %s with %d children in compressed mode",readfilename,msg_store->nbport) ;
    }
    /*
    ** WARNING ----------
    **
